...
const MOCK_ACTIVITIES = {
  surgery: [
    { date: '01/10/2023', rotation: 'Cirurgia Geral', hospital: 'Hosp. Municipal Infantil', ch: '12h', activity: 'Acompanhamento em enfermaria e atendimento ambulatorial pediátrico.', signer: 'Dr. André Luiz' },
    { date: '02/10/2023', rotation: 'Cirurgia Geral', hospital: 'Hosp. Municipal Infantil', ch: '10h', activity: 'Plantão noturno em pronto-atendimento e triagem.', signer: 'Dra. Marta Souza' },
    { date: '04/10/2023', rotation: 'Cirurgia Geral', hospital: 'Maternidade Central', ch: '12h', activity: 'Auxílio em partos vaginais e suturas de lacerações.', signer: 'Dr. Roberto Lima' },
    { date: '05/10/2023', rotation: 'Cirurgia Geral', hospital: 'Maternidade Central', ch: '10h', activity: 'Consulta pré-natal de alto risco.', signer: 'Dra. Marta Souza' },
  ],
  clinical: [
    { date: '01/10/2023', rotation: 'Clínica Médica', hospital: 'Hospital das Clínicas', ch: '12h', activity: 'Ronda em enfermaria de clínica médica.', signer: 'Dr. Ricardo Martins' },
    { date: '02/10/2023', rotation: 'Clínica Médica', hospital: 'Hospital das Clínicas', ch: '12h', activity: 'Atendimento ambulatorial de pacientes crônicos.', signer: 'Dr. Ricardo Martins' },
  ],
}

function getActivitiesForRotation(key) {
  return MOCK_ACTIVITIES[key] || MOCK_ACTIVITIES.surgery
}

export default function StudentRotationReport() {
  const { rotationKey } = useParams()
  const navigate = useNavigate()
  const { t } = useTranslation()

  const activities = getActivitiesForRotation(rotationKey)
        ...
        <article className="student-report-document">
          <div className="student-report-doc-header">
            ...
            <div className="student-report-doc-codes">
              <span>COD: MED-REG-2026-V1</span>
              <span>AUTENTICIDADE: {rotationKey ? String(rotationKey).slice(0, 4).toUpperCase() : 'XXXX'}-XF21-LL09</span>
            </div>
          </div>
